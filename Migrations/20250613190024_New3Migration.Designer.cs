...
namespace ProjectSpetses.Migrations
{
    ...
    [Migration("20250613190024_New3Migration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjectSpetses.Models.Entities.PointsEarned", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");

                    b.Property<long>("Section1Easy")
                        .HasColumnType("bigint");

                    b.Property<long>("Section1Hard")
                        .HasColumnType("bigint");

                    b.Property<long>("Section2Easy")
                        .HasColumnType("bigint");

                    b.Property<long>("Section2Hard")
                        .HasColumnType("bigint");

                    b.Property<long>("Section3Easy")
                        .HasColumnType("bigint");

                    b.Property<long>("Section3Hard")
                        .HasColumnType("bigint");

                    b.Property<long>("Section4Easy")
                        .HasColumnType("bigint");

                    b.Property<long>("Section4Hard")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ProjectSpetses.Models.Entities.Stats", b =>
                {
                    ...
                    b.PrimitiveCollection<string>("CategoriesCompleted")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.PrimitiveCollection<string>("SectionsCompleted")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("ProjectSpetses.Models.Entities.PointsEarned", b =>
                {
                    b.HasOne("ProjectSpetses.Models.Entities.User", "User")
                        .WithOne("PointsEarned")
                        .HasForeignKey("ProjectSpetses.Models.Entities.PointsEarned", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
